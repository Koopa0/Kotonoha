...
const List<InfoDrill> kInfoDrills = [
  ...
  InfoDrill(
    ...
    wrongAnswers: ['3000日圓', '500日圓'],
    requiredSeenIds: ['word:ご', 'word:せん', 'word:えん'],
  ...
  InfoDrill(
    ...
    kind: InfoKind.time,
    sceneZh: '告示說明關門時間。',
    promptKana: 'ごご じゅう じ です',
    promptRomaji: 'gogo juu ji desu',
    promptMeaning: '（時間是）下午十點',
    correctAnswer: '下午10點',
    wrongAnswers: ['上午10點', '下午3點半'],
    requiredSeenIds: ['word:ごご', 'word:じゅう', 'word:じ'],
    assembledFromParts: true,
  ),
  InfoDrill(
    id: 'info:person-1',
  ...
  InfoDrill(
    ...
    sceneZh: '窗口核對這張團體票。',
    promptKana: 'よにん です',
    promptRomaji: 'yonin desu',
    promptMeaning: '（人數是）四位',
    correctAnswer: '4位',
    wrongAnswers: ['1位', '3位'],
    requiredSeenIds: ['word:よにん'],
  ),
  InfoDrill(
    id: 'info:person-3',
    kind: InfoKind.personCount,
    ...
    correctAnswer: '3位',
    wrongAnswers: ['1位', '5位'],
    requiredSeenIds: ['word:さん', 'word:にん'],
    assembledFromParts: true,
  ),
  InfoDrill(
    id: 'info:person-5',
    ...
    sceneZh: '導覽員核對集合的人數。',
    promptKana: 'ごにん です',
    promptRomaji: 'gonin desu',
    promptMeaning: '（人數是）五位',
    correctAnswer: '5位',
    wrongAnswers: ['2位', '3位'],
    requiredSeenIds: ['word:ご', 'word:にん'],
    assembledFromParts: true,
  ),
];
