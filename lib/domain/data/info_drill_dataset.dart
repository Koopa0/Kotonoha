...
const List<InfoDrill> kInfoDrills = [
  ...
  InfoDrill(
    ...
    kind: InfoKind.amount,
    sceneZh: '自動售票機播報票價。',
    promptKana: 'ごせん えん です',
    promptRomaji: 'gosen en desu',
    promptMeaning: '（價格是）五千日圓',
    correctAnswer: '5000日圓',
    wrongAnswers: ['3000日圓', '6000日圓'],
    requiredSeenIds: [],
    requiredPartIds: ['word:ご', 'word:せん', 'word:えん'],
  ),
  InfoDrill(
    id: 'info:time-9am',
    kind: InfoKind.time,
    sceneZh: '園區廣播提醒入場時間。',
    promptKana: 'ごぜん く じ です',
    promptRomaji: 'gozen ku ji desu',
    promptMeaning: '（時間是）上午九點',
    correctAnswer: '上午9點',
    wrongAnswers: ['上午10點', '下午9點'],
    requiredSeenIds: [],
    requiredPartIds: ['word:ごぜん', 'word:く', 'word:じ'],
  ),
  InfoDrill(
    id: 'info:person-3',
    kind: InfoKind.personCount,
    sceneZh: '閘門工作人員確認人數。',
    promptKana: 'さんにん です',
    promptRomaji: 'sannin desu',
    promptMeaning: '（人數是）三位',
    correctAnswer: '3位',
    wrongAnswers: ['1位', '2位'],
    requiredSeenIds: [],
    requiredPartIds: ['word:さん', 'word:にん'],
  ),
];
