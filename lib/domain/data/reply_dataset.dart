...
const List<ReplyDrill> kReplyDrills = [
  ReplyDrill(
    ...
    replyWrongKana: ['みぎです', 'はい', 'おおさかです'],
    requiredSeenIds: ['phrase:どこへ いく'],
  ),
  ReplyDrill(
    id: 'reply:doko-e-iku-osaka',
    scene: ReplySceneId.station,
    sceneZh: '檢票口。此行前往大阪。',
    promptKana: 'どこへ いく',
    promptRomaji: 'doko e iku',
    ...
    intentCorrect: '問你要去哪裡',
    intentWrong: ['問車站在哪裡', '問這裡是不是車站'],
    replyCorrectKana: 'おおさかです',
    replyCorrectRomaji: 'oosaka desu',
    replyCorrectMeaning: '我去大阪',
    replyWrongKana: ['みぎです', 'はい', 'きょうとです'],
    requiredSeenIds: ['phrase:どこへ いく'],
  ),
  ReplyDrill(
    ...
    replyWrongKana: ['はい', 'きょうとです', 'おおさかです'],
  ...
  ReplyDrill(
    ...
    replyWrongKana: ['みぎです', 'きょうとです', 'おおさかです'],
